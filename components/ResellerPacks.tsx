      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-block mt-6 px-6 py-3 bg-gray-50 rounded-full">
            <p className="text-lg font-semibold text-[#D52B1E]">
              1 CREDIT = 1 MONAT
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div>
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center transform rotate-2 shadow-lg" style={{ background: 'linear-gradient(135deg, #1C1C1C, #D52B1E)' }}>
        ...
        <div className="text-center mt-16">
          ...
          <a
            ...
            onClick={() => (window as any).gtag?.('event', 'conversion', { send_to: 'AW-18116637757/wWiHCJafnaMcEL3o175D' })}
