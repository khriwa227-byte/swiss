            ...
            <div className="space-y-8">
              <div className="p-6 bg-gray-50 rounded-3xl border border-gray-100">
                <p className="text-sm font-medium leading-relaxed">
                  IPTVNederland helpt duizenden klanten met premium IPTV. Voor snelle service, WhatsApp ons voor een reactie binnen 5 minuten, bel <a href="tel:+447449708976" className="font-bold hover:underline" style={{ color: '#AE1C28' }}>+44 7449708976</a> of mail <a href="mailto:info@iptvnederland.digital" className="font-bold hover:underline" style={{ color: '#AE1C28' }}>info@iptvnederland.digital</a>.
                </p>
              </div>
